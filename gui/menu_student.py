...
class MenuUser:
    def __init__(self,master):
        ...
        self.lblTitle=Label(self.frame,text='GESTION UTILISATEURS',font=('italique',28,'bold'),bg='white',fg='black')
        ...
        self.btnLogin=Button(self.LoginFrame1,text = 'CLOSE',width=10,command=self.iExit,bg='blue')#self.new_window#
        self.btnLogin.grid(row=3,column=0,columnspan=2)
    ...
    def gotoViewUsers(self):
        self.newWindow=Toplevel(self.master)
        #self.app=ViewUsers(self.newWindow)
